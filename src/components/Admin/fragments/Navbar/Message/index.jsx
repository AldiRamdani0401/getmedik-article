...
const Message = (props) => {
  ...
  return (
    <div class="relative cursor-pointer" >
      <div  class={`flex items-center justify-center h-10 w-10 rounded-full hover:text-[#0b5555] hover:border-2 hover:bg-white ${isClick() ? 'border-[2.5px] bg-white border-white text-[#15adad]' : ''}`}
        onclick={() => {
